...
pacman::p_load(tidyverse, magrittr, countrycode, reshape2, car)
...
cntry_keeps <- c("Austria_8","Belgium_8","Czech Republic_8", "Israel_8",
                 "Denmark_7","Estonia_8","Finland_8","France_8","Germany_8","Hungary_7",
                 "Iceland_8","Ireland_8","Lithuania_7","Netherlands_8","Norway_8","Poland_8",
                 "Portugal_7","Russian Federation_8","Slovenia_8","Spain_7","Sweden_8","Switzerland_8",
                 "United Kingdom of Great Britain and Northern Ireland_8")
...
ess_cntrys <- c("Denmark", "Spain", "Hungary", "Lithuania", "Portugal", "Austria", 
"Belgium", "Switzerland", "Czech Republic", "Germany", "Estonia", 
"Finland", "France", "United Kingdom of Great Britain and Northern Ireland", 
...
fit2 <- lme4::lmer(matters ~ direct_dem + knowledge2 + direct_dem*knowledge2 + (1|cntry), data = combined)
texreg::screenreg(fit2)
plot_model(fit2, show.data = T, type = "pred",  terms = "direct_dem")
